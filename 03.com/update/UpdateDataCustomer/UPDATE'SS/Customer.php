...
<body>
    ...
    <div class="container-fluid">
                ...
                <form id="dataForm" action="customer_hapus.php" method="post">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT customer_id, nama_customer, alamat, telepon, email FROM customer ORDER BY customer_id";
                            ...
                            ?>
                            <tr>
                                <td><input type="checkbox" class="checkbox-item" value="<?php echo $data['customer_id']; ?>"></td>
        ...
        <div class="action-buttons">
            ...
            <button class="btn btn-danger" onclick="document.getElementById('dataForm').action='customer_hapus.php'; document.getElementById('dataForm').submit();">Delete</button>
        </div>
    </div>
